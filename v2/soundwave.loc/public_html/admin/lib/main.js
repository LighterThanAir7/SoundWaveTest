...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // for forcing rerender of vue-components that use the ContentHook
        ...
        MorePopover.prototype.queryHit = function (positionLeft, positionTop, elWidth, elHeight) {
            ...
            if (positionLeft >= 0 && positionLeft < elWidth &&
                ...
                return {
                    ...
                    layer: 1, // important when comparing with hits from other vue-components
                };
            }
            return null;
        };
    ...
    */
    var ScrollGrid = /** @class */ (function (_super) {
        ...
        ScrollGrid.prototype.renderChunk = function (sectionConfig, sectionIndex, colGroupStat, microColGroupNode, chunkConfig, chunkIndex, rowHeights, isHeader) {
            ...
            // but if these values were to change, the inner vue-components would be unmounted/remounted because of the parent change.
